...
public class OwnsSQL {
    ...
    public static final String getTeamsUserOwnsSQL = "SELECT Owns_ID, User_ID, teams.Team_ID, Amount_Owned, Name, Seed, Point_Spread, Is_Out, Current_Market_Price, teams.Is_Locked FROM owns " +
