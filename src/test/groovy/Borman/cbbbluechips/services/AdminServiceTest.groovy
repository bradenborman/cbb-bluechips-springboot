...
//    }
    ...
    def 'validateChangeOfPointSpread VALID'() {
        ...
        given:
            AdminService adminService = new AdminService(null, null, null, null, null)
            List<Borman.cbbbluechips.models.UpdatePointSpreadRequest> updates = Arrays.asList(
                    new Borman.cbbbluechips.models.UpdatePointSpreadRequest(nextPointSpread: -3.5),
                    new Borman.cbbbluechips.models.UpdatePointSpreadRequest(nextPointSpread: 3.5),
                    new Borman.cbbbluechips.models.UpdatePointSpreadRequest(nextPointSpread: -8.1),
                    new Borman.cbbbluechips.models.UpdatePointSpreadRequest(nextPointSpread: 8.1)
            )
        when:
            adminService.validateChangeOfPointSpread(updates)
